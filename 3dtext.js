...
var varresul=0;
        ...
        var _ctx, _canvas, _engine, _scene, _light, _light2, _camera, _material, _mesh, canMain, _isFinish = false;
          ...
          // new FreeCamera(name: string, position: Vector3, scene: Scene, setActiveOnSceneIfNoneActive?: boolean):
           ...
           _camera.setPosition(new BABYLON.Vector3(0, 0, -20));
            ...
            _material.diffuseColor = new BABYLON.Color3.FromHexString("#0000FF");

      // Create the 3D UI manager
  var anchor = new BABYLON.TransformNode("");

            var manager = new BABYLON.GUI.GUI3DManager(_scene);
         ...
         /*  var addButton = function() {
                ...
                button.pointerDownAnimation = function bt() {
                     alert(7777);
                }
            }
        */
 ...
 var uno= new BABYLON.GUI.HolographicButton("orientation");
                panel.addControl(uno);
        
               uno.text = "uno" ;

                uno.pointerDownAnimation = function bt() {

                  if(varvalor=="hola"){varvalor="";}
                 varvalor=varvalor+"1";
              

                escriba(varvalor);
                }
                var dos= new BABYLON.GUI.HolographicButton("orientation");
                panel.addControl(dos);
                dos.text = "dos" ;
                dos.pointerDownAnimation = function bt() {
                 if(varvalor=="hola"){varvalor="";}
                 varvalor=varvalor+"2";                escriba(varvalor);
                }

                var suma= new BABYLON.GUI.HolographicButton("orientation");
                panel.addControl(suma);
                suma.text = "dos" ;
                suma.pointerDownAnimation = function bt() {
                 if(varvalor=="hola"){varvalor="";}
                var_a=varvalor;escriba(var_a+"+");
                limpiarvar();
                }

                   var igual= new BABYLON.GUI.HolographicButton("orientation");
                panel.addControl(igual);
                igual.text = "dos" ;
                igual.pointerDownAnimation = function bt() {
                 if(varvalor=="hola"){varvalor="";}
                var_b=varvalor; varresul=parseFloat(var_a)+parseFloat(var_b); escriba(varresul);
                alert(varresul);
                //limpiarvar();
               // resertvar();
                }
...
//butVectorize.onclick = function () {
 ...
 function  escriba(st) {
    ...
    if (!st=="") {
        ...
        var size = parseInt(3);// esye si
        var val=varvalor;
        var data = vectorizeText(st, canvas, context, {
            polygons: true,
            textBaseline: "top",
            fontStyle:"normal",
            // selStyle.value,
